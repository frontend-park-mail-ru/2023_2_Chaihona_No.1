...
templates['comment'] = template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<link rel=\"stylesheet\" href=\"components/Comment/comment.css\">\r\n<div class=\"comment\">\r\n    <div class=\"comment-ava\"><img src=\"img/"
    ...
    + alias4(container.lambda(((stack1 = (depth0 != null ? lookupProperty(depth0,"user") : depth0)) != null ? lookupProperty(stack1,"login") : stack1), depth0))
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"creation_date") || (depth0 != null ? lookupProperty(depth0,"creation_date") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"creation_date","hash":{},"data":data,"loc":{"start":{"line":7,"column":36},"end":{"line":7,"column":53}}}) : helper)))
    + "</div>\r\n    </div>\r\n</div>";
},"useData":true});
})();